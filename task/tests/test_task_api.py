...
def common_user():
    user = User.objects.create_user(
        email="test@test.com", password="Aa@1234%"
    )
    return user
...
class TestTaskApi:
    ...
    def test_post_task_response_status_200(self, api_client, common_user):
        url = reverse("task:api-v1:task-list")
        data = {
            "title": "Go to the gym",
            "is_done": False,
    ...
    def test_post_task_invalid_data_response_status_400(
